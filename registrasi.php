...
if (isset($_POST['simpan'])){
	...
	$user = $_POST ['user'];
	$pass = $_POST ['pass'];
	$tambah = mysqli_query ($conn, "INSERT INTO masyarakat(nik,nama,alamat,tlp,username,password)VALUES('$nik','$nama','$alamat',$tlp','$user','$pass')");
	if($tambah){
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Mila Ukk</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
